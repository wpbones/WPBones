...
abstract class WordPressCustomPostTypeServiceProvider extends ServiceProvider
{
     ...
     * @return string
     */
    public function enter_title_here($placeholder)
    {
        if (!$this->is()) {
            return $placeholder;
        }

        return $this->placeholderTitle($placeholder);
    }
     ...
     * @return string
     */
    public function placeholderTitle($placeholder)
    {
        return $placeholder;
    }
    ...
    {
        $new_columns = $this->columns($columns);
     ...
     */
    public function manage_posts_custom_column($column_id)
    {
        global $post;
